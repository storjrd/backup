...
dev:
	npm run serve & STORJ_BACKUP_USE_RELATIVE_RESTIC=true STORJ_BACKUP_DEV=true npm start

backend:
	STORJ_BACKUP_USE_RELATIVE_RESTIC=true STORJ_BACKUP_DEV=true npm start
