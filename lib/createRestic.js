...
const binaryPaths = {
	"win32-x64": `${__dirname}/../bin/restic_0.12.1_windows_amd64.exe`,
	"linux-x64": `${__dirname}/../bin/restic_0.12.1_linux_amd64`,
	"darwin-x64": `${__dirname}/../bin/restic_0.12.1_darwin_amd64`,
	"darwin-arm64": `${__dirname}/../bin/restic_0.12.1_darwin_arm64`
};
